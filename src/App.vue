<template>
    <v-app :class="dark ? 'f-dark' : ''">
        <v-app-bar app elevate-on-scroll clipped-left style="transition: 0s ease background-color, 280ms cubic-bezier(0.4, 0, 0.2, 1) box-shadow;" :dark="dark" :color="dark ? '#121212' : '#fff'">
            <v-app-bar-nav-icon
...
<!--                <f-picslide :dark="dark"></f-picslide>-->
                <f-contact style="display: block;opacity: 1;z-index: 1;" :dark="dark"></f-contact>
          ...
          <el-backtop :dark="dark" visibility-height="150" :right="10" :bottom="100">
            <div
                :dark="dark"
                style="{
                    height: 100%;
